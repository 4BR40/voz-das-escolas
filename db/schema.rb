...
ActiveRecord::Schema.define(version: 2020_12_10_051619) do
  ...
  create_table "problems", force: :cascade do |t|
    ...
    t.index ["school_id"], name: "index_problems_on_school_id"
  ...
  add_foreign_key "problems", "schools"
  add_foreign_key "problems", "users"
  add_foreign_key "reviews", "problems"
